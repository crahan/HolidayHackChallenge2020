...
**Direct link**: [kringleconsoc website](https://splunk.kringlecastle.com/en-US/app/SA-kringleconsoc/kringleconsoc)<br/>
...
??? hint "Adversary Emulation and Splunk - Minty Candycane"
...
![Image](../../img/objectives/o6/favorite_phrase.png)
...
![Image](../../img/objectives/o6/cyber_chef_solution.png){: class=border }
